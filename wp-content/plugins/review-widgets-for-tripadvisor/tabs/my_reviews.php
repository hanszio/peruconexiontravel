...
$wpdb->query("UPDATE `". $trustindex_pm_tripadvisor->get_tablename('reviews') ."` SET highlight = '$highlight' WHERE id = '$id'");
}
exit;
}
/* Replied flag saving:
...
if ($id && $reply) {
$wpdb->query("UPDATE `". $trustindex_pm_tripadvisor->get_tablename('reviews') ."` SET reply = '". str_replace("'", "\'", $reply) ."' WHERE id = '$id'");
}
exit;
}
if (isset($_POST['save-reply-generated'])) {
update_option($trustindex_pm_tripadvisor->get_option_name('reply-generated'), 1, false);
exit;
}
if (isset($_POST['review_download_request'])) {
check_admin_referer('ti-download-reviews');
delete_option($trustindex_pm_tripadvisor->get_option_name('review-download-token'));
update_option($trustindex_pm_tripadvisor->get_option_name('review-download-inprogress'), sanitize_text_field($_POST['review_download_request']), false);
update_option($trustindex_pm_tripadvisor->get_option_name('review-manual-download'), intval($_POST['manual_download']), false);
if (isset($_POST['review_download_request_id'])) {
update_option($trustindex_pm_tripadvisor->get_option_name('review-download-request-id'), sanitize_text_field($_POST['review_download_request_id']), false);
}
update_option($trustindex_pm_tripadvisor->get_option_name('review-download-modal'), 0, false);
...
$trustindex_pm_tripadvisor->save_reviews($pageDetails['reviews']);
}
update_option($trustindex_pm_tripadvisor->get_option_name('download-timestamp'), intval($_POST['review_download_timestamp']), false);
exit;
}
$reviews = [];
if ($trustindex_pm_tripadvisor->is_noreg_linked()) {
$reviews = $wpdb->get_results('SELECT * FROM `'. $trustindex_pm_tripadvisor->get_tablename('reviews') .'` ORDER BY date DESC');
}
$isReviewDownloadInProgress = $trustindex_pm_tripadvisor->is_review_download_in_progress();
...
"showLines": 2,
"lessText": "'. TrustindexPlugin_tripadvisor::___("Show less") .'",
"moreText": "'. TrustindexPlugin_tripadvisor::___("Show more") .'",
});
...
<p><?php echo TrustindexPlugin_tripadvisor::___('Connect your %s platform to download reviews.', [ "Tripadvisor" ]); ?></p>
</div>
<?php else: ?>
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-box-header"><?php echo TrustindexPlugin_tripadvisor::___('My Reviews'); ?></div>
...
<?php echo TrustindexPlugin_tripadvisor::___('Download new reviews');?>
<span class="ti-tooltip-message"><?php echo TrustindexPlugin_tripadvisor::___('Now, you can download your new reviews.'); ?></span>
</a>
<?php else: ?>
...
<?php echo TrustindexPlugin_tripadvisor::___('Download new reviews'); ?>
<span class="ti-tooltip-message"><?php echo TrustindexPlugin_tripadvisor::___('The manual review download will be available again in %d day(s).', [ $days ]); ?></span>
</a>
<?php endif; ?>
</div>
</div>
...
<?php if (!$isReviewDownloadInProgress): ?>
<div class="ti-notice notice-warning" style="margin-left: 0">
<p><?php echo TrustindexPlugin_tripadvisor::___('You had no reviews at the time of last review downloading.'); ?></p>
</div>
<?php endif; ?>
<?php else: ?>
...
<thead>
<tr>
<th class="text-center"><?php echo TrustindexPlugin_tripadvisor::___('Reviewer'); ?></th>
<th class="text-center" style="width: 90px;"><?php echo TrustindexPlugin_tripadvisor::___('Rating'); ?></th>
<th class="text-center"><?php echo TrustindexPlugin_tripadvisor::___('Date'); ?></th>
<th style="width: 50%"><?php echo TrustindexPlugin_tripadvisor::___('Text'); ?></th>
</tr>
</thead>
<tbody>
<?php foreach ($reviews as $review): ?>
<?php $review_text = $trustindex_pm_tripadvisor->getReviewHtml($review); ?>
...
else if (!in_array('tripadvisor', [ 'facebook', 'google' ])) {
$state = 'copy-reply';
}
$hideReplyButton = false;
if (in_array('tripadvisor', [ 'facebook', 'google' ])) {
$hideReplyButton = $isReviewDownloadInProgress || get_option($trustindex_pm_tripadvisor->get_option_name('review-download-modal'), 1);
}
?>
<?php if (!$hideReplyButton): ?>
<?php if ($review->reply): ?>
<a href="#" class="btn-text btn-default btn-default-disabled btn-sm btn-show-ai-reply"><?php echo TrustindexPlugin_tripadvisor::___('Reply'); ?></a>
<?php else: ?>
<a href="#" class="btn-text btn-sm btn-show-ai-reply" data-edit-reply-text="<?php echo TrustindexPlugin_tripadvisor::___('Reply'); ?>"><?php echo TrustindexPlugin_tripadvisor::___('Reply with ChatGPT'); ?></a>
<?php endif; ?>
<?php endif; ?>
<?php if ($review->text): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="btn-text btn-sm btn-default btn-show-highlight<?php if (isset($review->highlight) && $review->highlight): ?> has-highlight<?php endif; ?>"><?php echo TrustindexPlugin_tripadvisor::___('Highlight text') ;?></a>
<?php endif; ?>
<?php if (!$hideReplyButton): ?>
...
<strong><?php echo TrustindexPlugin_tripadvisor::___('ChatGPT generated reply'); ?></strong>
<span><?php echo TrustindexPlugin_tripadvisor::___('you can modify before upload'); ?>
</div>
<textarea id="ti-ai-reply-<?php echo esc_attr($review->id); ?>" rows="1"></textarea>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="btn-text btn-sm btn-post-reply"><?php echo TrustindexPlugin_tripadvisor::___('Upload reply to %s', [ 'Tripadvisor' ]); ?></a>
<a href="#" class="btn-text btn-no-background btn-sm btn-hide-ai-reply"><?php echo TrustindexPlugin_tripadvisor::___('Cancel'); ?></a>
</div>
<div class="ti-reply-box-state state-replied">
<div class="ti-button-dropdown-title">
<strong><?php echo TrustindexPlugin_tripadvisor::___('Reply by %s', [ $pageDetails['name'] ]); ?></strong>
</div>
<div class="ti-alert d-none"><?php echo TrustindexPlugin_tripadvisor::___('Reply successfully uploaded.'); ?></div>
<p><?php echo esc_html($review->reply); ?></p>
<?php if ('tripadvisor' !== 'facebook'): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="btn-text btn-white btn-sm btn-show-edit-reply"><?php echo TrustindexPlugin_tripadvisor::___('Edit reply'); ?></a>
<?php endif; ?>
</div>
<div class="ti-reply-box-state state-edit-reply">
<div class="ti-button-dropdown-title">
<strong><?php echo TrustindexPlugin_tripadvisor::___('Edit reply'); ?></strong>
<span><?php echo TrustindexPlugin_tripadvisor::___('change your previous reply'); ?>
</div>
<textarea rows="1"><?php echo esc_html($review->reply); ?></textarea>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="btn-text btn-sm btn-post-reply"><?php echo TrustindexPlugin_tripadvisor::___('Upload reply to %s', [ 'Tripadvisor' ]); ?></a>
<a href="#" class="btn-text btn-no-background btn-sm btn-hide-edit-reply"><?php echo TrustindexPlugin_tripadvisor::___('Cancel'); ?></a>
</div>
<?php endif; ?>
<div class="ti-reply-box-state state-copy-reply">
<div class="ti-button-dropdown-title">
<strong><?php echo TrustindexPlugin_tripadvisor::___('Copy the reply'); ?></strong>
</div>
<div class="ti-alert ti-alert-warning d-none">
<?php echo TrustindexPlugin_tripadvisor::___('We could not connect your account with the review.'); ?>
<a href="#" class="btn-try-reply-again"><?php echo TrustindexPlugin_tripadvisor::___('Try again'); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo TrustindexPlugin_tripadvisor::___('Highlight text'); ?></strong>
<span><?php echo TrustindexPlugin_tripadvisor::___('just select the text you want to highlight'); ?>
</div>
...
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-highlight'); ?>" class="btn-text btn-sm btn-save-highlight"><?php echo TrustindexPlugin_tripadvisor::___('Save'); ?></a>
<a href="#" class="btn-text btn-no-background btn-sm btn-hide-highlight"><?php echo TrustindexPlugin_tripadvisor::___('Cancel'); ?></a>
<?php if ($review->highlight): ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-highlight'); ?>" class="btn-text btn-danger btn-sm btn-remove-highlight btn-pull-right"><?php echo TrustindexPlugin_tripadvisor::___('Remove highlight'); ?></a>
<?php endif; ?>
</div>
<?php endif; ?>
</td>
...
<?php if ($reviews && get_option($trustindex_pm_tripadvisor->get_option_name('review-download-modal'), 1) && in_array('tripadvisor', [ 'facebook', 'google' ])): ?>
<div class="ti-modal ti-rateus-modal" style="display: block">
<div class="ti-modal-dialog">
<div class="ti-modal-content">
<span class="ti-close-icon btn-modal-close"></span>
<div class="ti-modal-body">
<div class="ti-rateus-title"><?php echo TrustindexPlugin_tripadvisor::___('New feature: %s', [ TrustindexPlugin_tripadvisor::___('Reply with ChatGPT') ]); ?></div>
<p>
<?php echo TrustindexPlugin_tripadvisor::___('In order to use this feature, your reviews need to be updated.'); ?><br />
<?php echo TrustindexPlugin_tripadvisor::___('This could take a little while, so please refresh the page after 3 minutes!'); ?>
</p>
</div>
<div class="ti-modal-footer">
<a href="#" class="btn-text btn-default btn-modal-close"><?php echo TrustindexPlugin_tripadvisor::___('Cancel') ;?></a>
<a href="#" data-nonce="<?php echo wp_create_nonce('ti-download-reviews'); ?>" class="btn-text btn-refresh btn-download-reviews"><?php echo TrustindexPlugin_tripadvisor::___('Update') ;?></a>
</div>
</div>
</div>
</div>
...
<?php endif; ?>
<?php
$ti_campaign1 = 'wp-tripadvisor-4';
$ti_campaign2 = 'wp-tripadvisor-5';
