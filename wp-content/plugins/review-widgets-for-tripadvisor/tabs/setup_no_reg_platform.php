...
<input
class="form-control"
placeholder="<?php echo TrustindexPlugin_tripadvisor::___('e.g.:') . ' ' . esc_attr($exampleUrl); ?>"
id="page-link"
type="text"
required="required"
/>
...
<div class="results" data-errortext="<?php echo TrustindexPlugin_tripadvisor::___('Please add your URL again: this is not a valid %s page.', [ "Tripadvisor" ]); ?>"></div>
</div>
