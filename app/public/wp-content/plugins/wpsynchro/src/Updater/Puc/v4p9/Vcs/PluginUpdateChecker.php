<?php
if ( !class_exists('WPSynchroPuc_v4p9_Vcs_PluginUpdateChecker') ):

	class WPSynchroPuc_v4p9_Vcs_PluginUpdateChecker extends WPSynchroPuc_v4p9_Plugin_UpdateChecker implements WPSynchroPuc_v4p9_Vcs_BaseChecker {
		/**
		...
		/**
		 * WPSynchroPuc_v4p9_Vcs_PluginUpdateChecker constructor.
		 *
		...
		public function requestInfo($unusedParameter = null) {
			...
			$info = new WPSynchroPuc_v4p9_Plugin_Info();
		 ...
		 * @param WPSynchroPuc_v4p9_Plugin_Info $pluginInfo
		 */
