<?php
if ( !class_exists('WPSynchroPuc_v4p9_Metadata', false) ):
	 ...
	 * @access public
	 */
	abstract class WPSynchroPuc_v4p9_Metadata {
		...
		protected static function createFromJson($json, $target) {
			...
			if ( empty($apiResponse) || !is_object($apiResponse) ){
				...
				do_action('WPSynchroPuc_api_error', new WP_Error('puc-invalid-json', $errorMessage));
			...
			if ( is_wp_error($valid) ){
				do_action('WPSynchroPuc_api_error', $valid);
