<?php
if ( !class_exists('WPSynchroPuc_v4p9_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class WPSynchroPuc_v4p9_Plugin_UpdateChecker extends WPSynchroPuc_v4p9_UpdateChecker {
		...
		/**
		 * @var WPSynchroPuc_v4p9_Plugin_Package
		 */
		protected $package;
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$slugCheckFilter = 'WPSynchroPuc_is_slug_in_use-' . $slug;
			...
			$this->extraUi = new WPSynchroPuc_v4p9_Plugin_Ui($this);
		}
		...
		protected function createScheduler($checkPeriod) {
			$scheduler = new WPSynchroPuc_v4p9_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return WPSynchroPuc_v4p9_Plugin_Info
		 */
		public function requestInfo($queryArgs = []) {
			list($pluginInfo, $result) = $this->requestMetadata('WPSynchroPuc_v4p9_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var WPSynchroPuc_v4p9_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return WPSynchroPuc_v4p9_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = WPSynchroPuc_v4p9_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return WPSynchroPuc_v4p9_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var WPSynchroPuc_v4p9_Plugin_Update $update */
		...
		protected function createDebugBarExtension() {
			return new WPSynchroPuc_v4p9_DebugBar_PluginExtension($this);
		}
		...
		protected function createInstalledPackage() {
			return new WPSynchroPuc_v4p9_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return WPSynchroPuc_v4p9_Plugin_Package
		 */
