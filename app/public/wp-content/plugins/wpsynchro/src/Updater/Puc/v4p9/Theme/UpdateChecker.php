...
if ( !class_exists('WPSynchroPuc_v4p9_Theme_UpdateChecker', false) ):

	class WPSynchroPuc_v4p9_Theme_UpdateChecker extends WPSynchroPuc_v4p9_UpdateChecker {
		 ...
		 *
		 * @return WPSynchroPuc_v4p9_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('WPSynchroPuc_v4p9_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var WPSynchroPuc_v4p9_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new WPSynchroPuc_v4p9_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createDebugBarExtension() {
			return new WPSynchroPuc_v4p9_DebugBar_Extension($this, 'WPSynchroPuc_v4p9_DebugBar_ThemePanel');
		}
		...
		protected function createInstalledPackage() {
			return new WPSynchroPuc_v4p9_Theme_Package($this->stylesheet, $this);
		}
	}
