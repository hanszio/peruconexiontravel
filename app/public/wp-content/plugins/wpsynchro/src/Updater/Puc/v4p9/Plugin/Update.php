<?php
if ( !class_exists('WPSynchroPuc_v4p9_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class WPSynchroPuc_v4p9_Plugin_Update extends WPSynchroPuc_v4p9_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = WPSynchroPuc_v4p9_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param WPSynchroPuc_v4p9_Plugin_Info $info
		 * @return WPSynchroPuc_v4p9_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|WPSynchroPuc_v4p9_Plugin_Info|WPSynchroPuc_v4p9_Plugin_Update $object The source object.
		 * @return WPSynchroPuc_v4p9_Plugin_Update The new copy.
		 */
