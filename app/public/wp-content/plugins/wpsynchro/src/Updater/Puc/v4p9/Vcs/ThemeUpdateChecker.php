...
if ( !class_exists('WPSynchroPuc_v4p9_Vcs_ThemeUpdateChecker', false) ):

	class WPSynchroPuc_v4p9_Vcs_ThemeUpdateChecker extends WPSynchroPuc_v4p9_Theme_UpdateChecker implements WPSynchroPuc_v4p9_Vcs_BaseChecker {
		/**
		...
		/**
		 * @var WPSynchroPuc_v4p9_Vcs_Api Repository API client.
		 */
		protected $api = null;

		/**
		 * WPSynchroPuc_v4p9_Vcs_ThemeUpdateChecker constructor.
		 *
		 * @param WPSynchroPuc_v4p9_Vcs_Api $api
		...
		public function requestUpdate() {
			...
			$update = new WPSynchroPuc_v4p9_Theme_Update();
			...
			$update->version = WPSynchroPuc_v4p9_Utils::findNotEmpty(array(
				$remoteHeader['Version'],
				WPSynchroPuc_v4p9_Utils::get($updateSource, 'version'),
			));

			//The details URL defaults to the Theme URI header or the repository URL.
			$update->details_url = WPSynchroPuc_v4p9_Utils::findNotEmpty(array(
