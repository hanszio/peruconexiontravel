<?php
if ( !class_exists('WPSynchroPuc_v4p9_DebugBar_Extension', false) ):

	class WPSynchroPuc_v4p9_DebugBar_Extension {
		const RESPONSE_BODY_LENGTH_LIMIT = 4000;

		/** @var WPSynchroPuc_v4p9_UpdateChecker */
		protected $updateChecker;
		protected $panelClass = 'WPSynchroPuc_v4p9_DebugBar_Panel';
		...
		public function __construct($updateChecker, $panelClass = null) {
			...
			add_action('wp_ajax_WPSynchroPuc_v4_debug_check_now', array($this, 'ajaxCheckNow'));
		}
		...
		private function getLibraryUrl($filePath) {
			...
			$absolutePath = WPSynchroPuc_v4p9_Factory::normalizePath($absolutePath);

			$pluginDir = WPSynchroPuc_v4p9_Factory::normalizePath(WP_PLUGIN_DIR);
			$muPluginDir = WPSynchroPuc_v4p9_Factory::normalizePath(WPMU_PLUGIN_DIR);
			$themeDir = WPSynchroPuc_v4p9_Factory::normalizePath(get_theme_root());
