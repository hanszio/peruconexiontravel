...
if ( !class_exists('WPSynchroPuc_v4p9_Vcs_GitHubApi', false) ):

	class WPSynchroPuc_v4p9_Vcs_GitHubApi extends WPSynchroPuc_v4p9_Vcs_Api {
		/**
		...
		public function getLatestRelease() {
			...
			$reference = new WPSynchroPuc_v4p9_Vcs_Reference(array(
