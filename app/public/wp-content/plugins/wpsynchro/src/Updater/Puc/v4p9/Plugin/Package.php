<?php
if ( !class_exists('WPSynchroPuc_v4p9_Plugin_Package', false) ):

	class WPSynchroPuc_v4p9_Plugin_Package extends WPSynchroPuc_v4p9_InstalledPackage {
		/**
		...
		public function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				if (($muPluginDir === false) || ($pluginPath === false)) {
					...
					$pluginPath  = WPSynchroPuc_v4p9_Factory::normalizePath($this->pluginAbsolutePath);
				}
