<?php
if ( !class_exists('WPSynchroPuc_v4p9_Vcs_Api') ):

	abstract class WPSynchroPuc_v4p9_Vcs_Api {
		 ...
		 * For example, "WPSynchroPuc_request_info_options-slug" or "WPSynchroPuc_request_update_options_theme-slug".
		 */
		...
		/**
		 * WPSynchroPuc_v4p9_Vcs_Api constructor.
		 *
