<?php
if ( !class_exists('WPSynchroPuc_v4p9_Factory', false) ):
	 ...
	 */
	class WPSynchroPuc_v4p9_Factory {
		 ...
		 * @return WPSynchroPuc_v4p9_Plugin_UpdateChecker|WPSynchroPuc_v4p9_Theme_UpdateChecker|WPSynchroPuc_v4p9_Vcs_BaseChecker
		 */
		 ...
		 *
		 * @see WPSynchroPuc_v4p9_UpdateChecker::__construct
		 *
		...
		private static function getServiceURI($fullPath) {
			...
			if ( is_readable($fullPath) ) {
				...
				$seek = apply_filters('WPSynchroPuc_get_source_uri', $seek);
		...
		private static function getVcsService($metadataUrl) {
			...
			return apply_filters('WPSynchroPuc_get_vcs_service', $service, $host, $path, $metadataUrl);
		}
