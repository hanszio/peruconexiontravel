...
if ( !class_exists('WPSynchroPuc_v4p9_Theme_Update', false) ):

	class WPSynchroPuc_v4p9_Theme_Update extends WPSynchroPuc_v4p9_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|WPSynchroPuc_v4p9_Theme_Update $object The source object.
		 * @return WPSynchroPuc_v4p9_Theme_Update The new copy.
		 */
