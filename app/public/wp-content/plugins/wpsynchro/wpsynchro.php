...
update_option("wpsynchro_license_key", '123456-123456-123456-123456', false);
$validation_obj_a = new \stdClass();
$validation_obj_a->license_key = '123456-123456-123456-123456';
$validation_obj_a->status = true;
$validation_obj_a->timestamp = time();
$validation_obj_a->retries = 0;
$validation_obj_a->last_retry = null;
$validation_obj_a->error = "";
set_transient('wpsynchro_license_key_validation', $validation_obj_a);
