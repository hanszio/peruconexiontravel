...
- <?php echo TrustindexPlugin_tripadvisor::___('Your subscription ID:'); ?> <strong><?php echo esc_html($trustindex_subscription_id); ?></strong><br />
<?php if ($ti_package): ?>
- <?php echo TrustindexPlugin_tripadvisor::___('Your package:'); ?> <strong><?php echo esc_html(TrustindexPlugin_tripadvisor::___($ti_package)); ?></strong>
<?php endif; ?>
</p>
<?php if ($ti_package == "free"): ?>
<?php echo TrustindexPlugin_tripadvisor::get_noticebox("error", TrustindexPlugin_tripadvisor::___('Once the trial period has expired, the widgets will not appear. You can subscribe or switch back the the "%s" tab', [ TrustindexPlugin_tripadvisor::___('Free Widget Configurator') ])); ?>
<?php elseif ($ti_package == "trial"): ?>
<?php echo TrustindexPlugin_tripadvisor::get_noticebox("warning", TrustindexPlugin_tripadvisor::___('Once the trial period has expired, the widgets will not appear. You can subscribe or switch back the the "%s" tab', [ TrustindexPlugin_tripadvisor::___('Free Widget Configurator') ])); ?>
<?php endif; ?>
...
<button type="submit" class="btn btn-primary btn-refresh"><?php echo TrustindexPlugin_tripadvisor::___('CONNECT ACCOUNT');?></button>
<br />
<p class="text-center">
...
<p>
<?php echo TrustindexPlugin_tripadvisor::___('You have got %d widgets saved in Trustindex admin.', array($widget_number)); ?>
</p>
...
<a href=".code-ti-w-<?php echo esc_attr($wc_i .'-'. $wi_num); ?>" class="btn-text btn-copy2clipboard"><?php echo TrustindexPlugin_tripadvisor::___("Copy to clipboard") ;?></a>
<br />
<br />
</div>
</li>
