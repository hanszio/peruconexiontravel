...
{
delete_option($trustindex_pm_tripadvisor->get_option_name('review-download-notification'));
...
$tabs[ TrustindexPlugin_tripadvisor::___('Troubleshooting') ] = "troubleshooting";
...
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=<?php echo esc_attr($_GET['tab']); ?>&test_proxy" class="btn-text btn-refresh"><?php echo TrustindexPlugin_tripadvisor::___("Test again") ;?></a>
</div>
<?php endif; ?>
